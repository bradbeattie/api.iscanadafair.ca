    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seats', models.PositiveSmallIntegerField(db_index=True, help_text='Aggregate', null=True)),
            ],
            options={
                'ordering': ('number',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthdate', models.CharField(db_index=True, help_text='Exact birth dates for parliamentarians in the 1800s sometimes omitted day or month', max_length=10)),
                ('lop_item_code', models.SlugField(unique=True)),
                ('constituency_offices', django_extensions.db.fields.json.JSONField(default=dict)),
                ('hill_phone', models.CharField(db_index=True, max_length=20)),
                ('hill_fax', models.CharField(db_index=True, max_length=20)),
                ('preferred_language', models.PositiveSmallIntegerField(choices=[(1, 'English'), (2, 'Français'), (3, 'English / Français')], db_index=True, null=True)),
            ],
            options={
                'ordering': ('slug',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('major_census_subdivisions', django_extensions.db.fields.json.JSONField(default=dict)),
                ('area_km2', models.PositiveIntegerField(db_index=True, null=True)),
                ('postal_code_fsas', django_extensions.db.fields.json.JSONField(default=dict)),
                ('current_parliamentarian', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='riding', to='parliaments.Parliamentarian')),
